...
-- fzf-lua:
map({ "n", "v" }, "<Leader>ff", "<cmd>FzfLua files<CR>", opts, { desc = "Find File" })
map({ "n", "v" }, "<Leader>fr", "<cmd>FzfLua oldfiles<CR>", opts, { desc = "Recent File" })
map({ "n", "v" }, "<Leader>fw", "<cmd>FzfLua live_grep<CR>", opts, { desc = "Find Text" })
map({ "n", "v" }, "<Leader>fm", "<cmd>FzfLua keymaps<CR>", opts, { desc = "Keymaps" })
map({ "n", "v" }, "<Leader>fM", "<cmd>FzfLua man_pages<CR>", opts, { desc = "Man Pages" })
map({ "n", "v" }, "<Leader>fR", "<cmd>FzfLua registers<CR>", opts, { desc = "Registers" })
map({ "n", "v" }, "<Leader>fj", "<cmd>FzfLua commands<CR>", opts, { desc = "Commands" })
map({ "n", "v" }, "<Leader>fh", "<cmd>FzfLua highlights<CR>", opts, { desc = "Highlights" })
map({ "n", "v" }, "<Leader>ft", "<cmd>FzfLua todo<CR>", opts, { desc = "Todo" })
...
map({ "n", "v" }, "<Leader>go", "<cmd>FzfLua git_status<CR>", opts, { desc = "Open Changed File" })
map({ "n", "v" }, "<Leader>gc", "<cmd>FzfLua git_branches<CR>", opts, { desc = "Checkout Branch" })
map({ "n", "v" }, "<Leader>gm", "<cmd>FzfLua git_commits<CR>", opts, { desc = "Checkout Commit" })
...
map({ "n", "v" }, "<Leader>ls", "<cmd>FzfLua lsp_document_symbols<CR>", opts, { desc = "Document Symbols" })
map({ "n", "v" }, "<Leader>lS", "<cmd>FzfLua lsp_dynamic_workspace_symbols<CR>", opts, { desc = "Workspace Symbols" })
